...
| 014 | Move now label and hover sublabel lower, aligned below time scale dates | TimeMarkersBack.vue, TimeMarkersFront.vue | Increase now label `top` beyond 24px. Add floating hover sublabel at same Y position. See plan. | IN PLAN | — | Gate 1 pending. |
